...
console.log("About component loaded - " + new Date().toISOString());

const getBackgroundStyle = (currentMode) => {
    switch(currentMode) {
        case 'light':
            return {
...
const About = ({ mode }) => {
    console.log("Mode received in About component:", mode);
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item" style={{border: mode === "light" ? '2px solid black' : '2px solid white'}}>
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={backgroundStyle}>
