...
/**
 * Get the navigation bar style based on the current mode
 * @param {string} mode - The current mode (light, dark, or purple)
 * @returns {Object} The style object for the navbar
 */
...
/**
 * Navbar component for the TextUtils application
 * @param {Object} props - Component props
 * @param {string} props.mode - Current application mode (light, dark, or purple)
 * @param {string} props.title - Title of the application
 * @param {string} props.aboutText - Text for the About link
 * @param {Function} props.toggleLMode - Function to toggle light mode
 * @param {Function} props.toggleDMode - Function to toggle dark mode
 * @param {Function} props.togglePMode - Function to toggle purple mode
 */
